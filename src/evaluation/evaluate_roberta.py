"""
Phase 3: Out-of-Distribution (OOD) Evaluation (RoBERTa)
Evaluates the fine-tuned RoBERTa model on a dynamically generated, 
...
MODEL_DIR = os.path.join(BASE_DIR, "models", "roberta_pids")
...
def main():
    print(f"\n[{'='*60}]")
    print(" ZERO-DAY THREAT EVALUATION: ROBERTA ")
    print(f"[{'='*60}]\n")
    ...
    results_file = os.path.join(RESULTS_DIR, "roberta_ood_results.json")
