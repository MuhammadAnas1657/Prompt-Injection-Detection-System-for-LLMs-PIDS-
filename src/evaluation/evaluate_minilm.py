"""
Phase 3: Out-of-Distribution (OOD) Evaluation (MiniLM)
Evaluates the fine-tuned MiniLM model on a dynamically generated, 
...
MODEL_DIR = os.path.join(BASE_DIR, "models", "minilm_pids")
...
def main():
    print(f"\n[{'='*60}]")
    print(" ZERO-DAY THREAT EVALUATION: MINILM ")
    print(f"[{'='*60}]\n")
    ...
    results_file = os.path.join(RESULTS_DIR, "minilm_ood_results.json")
